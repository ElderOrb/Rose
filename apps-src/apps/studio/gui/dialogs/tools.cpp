...
void ttools::pre_show()
{
	...
	navigation->set_did_item_pre_change(boost::bind(&ttools::did_navigation_pre_change, this, _2));
	navigation->set_did_item_changed(boost::bind(&ttools::did_navigation_changed, this, _2));
...
void ttools::pre_image(twindow& window)
{
	...
	portrait->set_did_draw(boost::bind(&ttools::did_draw_showcase, this, _1, _2, _3));
