...
void tanim3::erase_animation(twindow& window)
{
	...
	tanim2& anim = anims_updating_[clicked_anim_];
	int res = gui2::show_message("", _("Do you want to erase this animation?"), gui2::tmessage::yes_no_buttons);
...
{
	tanim2& anim = anims_updating_[clicked_anim_];
	gui2::tedit_box::tparam param(_("Rename id"), null_str, _("Input new id"), anim.id_);
	{
		param.text_changed = boost::bind(&tanim3::did_anim_id_changed, this, _1);
...
void tanim3::do_erase_particular(const int at)
{
	...
	const int res = gui2::show_message(_("Confirm delete"), ss.str(), gui2::tmessage::yes_no_buttons);
